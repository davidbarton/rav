...
| -------------------------------------- | ------------------------------------------- | ----------------------------------------- | ------------------- | ------------------------------------------ |
| **Apify Profile Scrapers** (4+ actors) | `__NEXT_DATA`__ from `/add/<username>`      | Proxy pool, batch processing, JSON output | $15-25/mo + usage   | **YES** — trivially                        |
| **Apify Popular Accounts**             | `__NEXT_DATA`__ from `/explore/<keyword>`   | Category enumeration, profile merging     | $15-25/mo + usage   | **YES** — we verified the endpoint         |
| **Apify Spotlight Scrapers**           | `__NEXT_DATA_`_ from spotlight URLs         | Video metadata extraction                 | $5-15/mo + usage    | **YES** — data already in profile response |
