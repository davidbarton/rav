...
platform_choice/scripts/snap_ads_search_page2.sh '<paste next_link URL>' \
  platform_choice/data/samples/2026-04-07-snap-sponsored-content/ads_search_spotify_de_body.json
```
