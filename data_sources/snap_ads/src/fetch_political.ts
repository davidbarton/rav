 ...
 *
 * Usage:
 *   npx tsx src/fetch_political.ts                # download all years + summarize
 *   npx tsx src/fetch_political.ts --summary      # skip download, just summarize
 *   npx tsx src/fetch_political.ts --year 2024    # single year only
 *
 * Data source:
...
const DATA_DIR = path.resolve(__dirname, "..", "data", "political_ads");
