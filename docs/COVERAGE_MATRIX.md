...
| CZ-7 | Data relevant to manipulation/fraud | done | `prototype_min/build_dataset.mjs` (`detect_risk`), `prototype_min/data/normalized.json` (`risk_flags`, `risk_score`), `prototype_min/script.js` (risk rendering), `docs/RAVINEO_INTEL.md` | None |
| CZ-8 | Download real sample + document method/limits | done | `0_platform_choice/data/samples/2026-04-07-snap-sponsored-content/README.md`, sample JSON files in same folder, `0_platform_choice/notes/limits.md`, `prototype_min/build_dataset.mjs` | None |
...
| CZ-10 | Competitor ad spend | done | `prototype_min/build_dataset.mjs` (spend proxy model), `prototype_min/data/normalized.json` (`est_spend_*`), `prototype_min/README.md` (proxy caveat) | None |
...
| CZ-13 | Potential misuse (disinfo/scam/fake) | done | `prototype_min/build_dataset.mjs` (`detect_risk`, `risk_score`), `prototype_min/script.js` (risk column/cards), `prototype_min/index.html` | None |
...
| Risk score and flags rendering | `prototype_min/build_dataset.mjs`, `prototype_min/script.js` | CZ-7, CZ-13 |
