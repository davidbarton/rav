...
- Czech assignment contract baseline: `agents/CZECH_TASK_CONTRACT.md`
- Czech scope coverage tracker: `agents/COVERAGE_MATRIX.md`
- Ravineo product + dashboard intelligence: `agents/RAVINEO_INTEL.md`
- Source-tagged insight log: `agents/INSIGHT_LOG.md`
- Team conversation notes: `agents/TEAM_NOTES.md`
- Future-stage backlog: `agents/FUTURE_BACKLOG.md`
- Minimal prototype plan and implementation: `app/PLAN.md`, `app/README.md`

## Current phase focus

- Original Czech scope is fully covered in `agents/COVERAGE_MATRIX.md` (`done: 14`, `partial: 0`, `missing: 0`).
